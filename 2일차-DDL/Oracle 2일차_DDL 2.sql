...
SELECT * FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'USER_FOREIGN_KEY';
-- SYS_COO7114 -> PK_GRADE_CODE
-- 2. 제약조건 삭제
ALTER TABLE USER_FOREIGN_KEY
...
ALTER TABLE USER_FOREIGN_KEY
ADD REG_DATE DATE;
-- ex02) USER_FOREIGN_KEY 테이블에 REG_DATE DATE 컬럼을 삭제해주세요
ALTER TABLE USER_FOREIGN_KEY
DROP COLUMN USER_DATE;
DESC USER_FOREIGN_KEY;
-- ex03) USER_FOREIGN_KEY 테이블에 REG_DATE DATE 컬럼의 자료형을 VARCHAR2(10)으로 바꿔주세요
ALTER TABLE USER_FOREIGN_KEY
MODIFY REG_DATE VARCHAR2(10);
DESC USER_FOREIGN_KEY;
-- ex04) USER_FOREIGN_KEY 테이블에 REG_DATE DATE 컬럼을 이름을 USER_DATE로 변경해주세요
ALTER TABLE USER_FOREIGN_KEY 
...
RENAME USER_FOREIGN_KEY TO USER_TBL;
