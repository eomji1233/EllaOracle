...
-- c. 날짜 처리 함수
-- ADD_MONTH(), MONTHS_BETWEEN(), LAST_DAY(), EXTRACT, SYSDATE
...
ADD_MONTHS(HIRE_DATE, 3) "입사 후 3개월" FROM EMPLOYEE;
-- ex2) EMPLOYEE 테이블에서 사원의 이름, 입사일, 근무 개월 수를 조회하시오.
SELECT EMP_NAME "이름", HIRE_DATE "입사일", 
FLOOR(MONTHS_BETWEEN(SYSDATE, HIRE_DATE)) "근무 개월 수" FROM EMPLOYEE;
